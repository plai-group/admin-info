Check out the {wiki{(https://github.com/plai-group/admin-info/wiki) for lab policies and resources
...
* [Funding Acknowledgement](https://github.com/plai-group/admin-info/blob/master/Funding%20Acknowledgment.md)
...
* Grad admin - [Ben Chen](https://www.cs.ubc.ca/people/ben-chen) & [Parson Poon](https://www.cs.ubc.ca/people/parson-poon)
    * Email: grad-admin@cs.ubc.ca (Ben) & grad-info@cs.ubc.ca (Parson)
    * Office: ICICS 201
    * Topics - Ben:
        * Academic progress through program
        * Course scheduling
        * Awards
    * Topics - Parson
        * Registration or student status
        * General inquiries
...
* [CS leadership, faculty, & staff list](https://www.cs.ubc.ca/people)
