...
Note:
  * If Frank Wood is on the paper, all funding sources listed above must be acknowledged. 
  * If only an individual student is on a paper without Dr. Wood, please consult with the lab manager about which of the particular funding sources need to be acknowledged and how they should be referenced.
